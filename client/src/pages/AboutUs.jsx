...
export default function AboutUs() {
  ...
  return (
    <div className={`${dark ? "bg-slate-950 text-slate-100" : "bg-gray-50 text-slate-900"} min-h-screen transition-colors`}>
      {/* Theme Toggle */}
        ...
        <div className="container mx-auto relative z-10 px-6">
          <motion.div initial={{ y: 18, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border dark:border-slate-700 bg-white/80 dark:bg-slate-900/60" href="#who-we-are">
                Learn more
              </a>
            </div>
          </motion.div>
      ...
      <main className="container mx-auto px-6 -mt-12">
        ...
        <section id="who-we-are" className="grid md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl shadow-lg bg-white dark:bg-slate-900/60 backdrop-blur-md">
        ...
        {/* Beautiful divider */}
        <div className="my-10">
          <div className="h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent dark:from-transparent dark:via-slate-700 dark:to-transparent" />
        </div>
        ...
        <section className="mt-10 grid md:grid-cols-3 gap-6 items-stretch">
          <div className="col-span-2 p-6 rounded-2xl bg-gradient-to-r from-white/80 to-blue-50 dark:from-slate-900/60 dark:to-slate-950/40 shadow">
          ...
          <div className="p-6 rounded-2xl bg-white/90 dark:bg-slate-900/60 shadow flex flex-col justify-between">
            <div>
        ...
        <section className="mt-12 max-w-7xl mx-auto px-0 pb-20">
          ...
          <div className="relative w-full h-[600px] bg-gray-100 dark:bg-slate-800 rounded-2xl overflow-hidden shadow-lg">
      ...
      <footer className="py-8 text-center text-sm opacity-70 border-t border-gray-200 dark:border-slate-700 mt-6">
...
function ValueCard({ icon, title, desc }) {
  return (
    <div className="p-4 rounded-lg border dark:border-slate-700 bg-white/80 dark:bg-slate-900/50">
...
function LeaderCard({ name, title, bio }) {
  return (
    <div className="p-4 rounded-lg bg-white/90 dark:bg-slate-900/60 border shadow">
      <div className="flex items-center gap-3">

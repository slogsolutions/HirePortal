  ...
  return (
    <div className="font-sans bg-gray-50 text-gray-900">
      ...
      <section className="py-20 bg-white text-center">
        <h2 className="text-3xl font-bold mb-10 text-gray-900">Used Across Departments</h2>
      ...
      <footer className="bg-gray-900 text-gray-400 py-10 text-center text-sm">
        ...
        <div className="mt-4 flex justify-center gap-6 text-gray-400">
          ...
          <a href="#" className="hover:text-white">Departments</a>
...
function FeatureCard({ icon, title, desc }) {
  return (
    <div className="bg-gray-50 hover:bg-white hover:shadow-lg transition rounded-2xl p-8 border text-left">

  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl shadow divide-y overflow-hidden">
        {/* header row */}
        <div className="hidden md:grid grid-cols-6 gap-4 p-4 text-sm font-semibold text-gray-600">
                ...
                {table.getRowModel().rows.map((row) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="grid grid-cols-1 md:grid-cols-6 gap-4 items-center p-4 hover:bg-gray-50"
                    >
      ...
      <div className="flex items-center justify-between mt-4 text-sm">
        <div className="text-gray-600">Showing {table.getRowModel().rows.length} of {candidates.length} entries</div>
        <div className="flex items-center gap-2">
